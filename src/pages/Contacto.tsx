  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="pt-20">
        ...
        <h1 className="text-6xl md:text-7xl brand-heading mb-8 [text-shadow:_0_4px_12px_rgb(0_0_0_/_90%)]" style={{color: '#ffffff'}}>
          CONTACTO
        </h1>
        <p className="text-2xl md:text-3xl brand-subheading max-w-3xl [text-shadow:_0_4px_8px_rgb(0_0_0_/_90%)]" style={{color: '#ffffff'}}>
        ...
        {contactSections.map((section, index) => (
          <div key={index} className="py-24 bg-gray-50">
            <div className="container mx-auto px-4 md:px-8">
              <div className={`grid grid-cols-1 md:grid-cols-2 gap-16 items-center ${
                ...
                <div className={`${section.imageLeft ? '' : 'md:order-1'} px-4 md:px-8`}>
